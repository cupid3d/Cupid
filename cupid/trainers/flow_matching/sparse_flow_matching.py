...
from .mixins.image_conditioned import ImageConditionedMixin, VisualImageConditionedMixin
...
class SparseFlowMatchingTrainer(FlowMatchingTrainer):
    ...
    def prepare_dataloader(self, num_workers=8, **kwargs):
        """
        Prepare dataloader.
        """
...
class VisualImageConditionedSparseFlowMatchingCFGTrainer(VisualImageConditionedMixin, SparseFlowMatchingCFGTrainer):
    """
    Trainer for sparse image-conditioned diffusion model with flow matching objective and classifier-free guidance.
    """
    pass
