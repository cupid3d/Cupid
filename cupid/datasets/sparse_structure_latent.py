...
class SparseStructureWithLatent(SparseStructureLatent, SparseStructure):
    """
    Sparse structure dataset with sparse structure latent
    """
    @torch.no_grad()
...
class ImageConditionedSparseStructureWithLatent(ImageConditionedMixin, SparseStructureWithLatent):
    """
    Image-conditioned sparse structure dataset with sparse structure latent
    """
    pass